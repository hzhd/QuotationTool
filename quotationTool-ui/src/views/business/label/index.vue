<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="标签特征" prop="labelFeatures">
        <el-select v-model="queryParams.labelFeatures" placeholder="请选择课程状态" clearable>
                  <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['business:label:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['business:label:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:label:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="labelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标签特征" align="center" prop="labelFeatures" />
      <el-table-column label="标签类型" align="center" prop="labelType" >
      <template slot-scope="scope">
                      <dict-tag :options="dict.type.label_type" :value="scope.row.labelType"/>
                    </template>
                  </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="标签名称" prop="labelName">
         ...
         <el-form-item label="标签特征" prop="labelFeatures">
                  <el-input v-model="form.labelFeatures" placeholder="请输入标签特征" />
                </el-form-item>
...
<script>
import { listLabel, getLabel, delLabel, addLabel, updateLabel } from "@/api/business/label";

export default {
  name: "Label",
  dicts: ['sys_normal_disable','label_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除标签库编号为"' + labelIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('business/label/export', {
        ...this.queryParams
