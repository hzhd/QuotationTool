<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:classify:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:classify:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="classifyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="档案编号" align="center" prop="recordCode" />
      <el-table-column label="档案类型" align="center" prop="recordType" />
      <el-table-column label="档案二维码" align="center" prop="recordQr" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="档案编号" prop="recordCode">
          <el-input v-model="form.recordCode" placeholder="请输入档案编号" />
        </el-form-item>
        <el-form-item label="档案二维码" prop="recordQr">
          <el-input v-model="form.recordQr" placeholder="请输入档案二维码" />
        </el-form-item>
...
<script>
import { listClassify, getClassify, delClassify, addClassify, updateClassify } from "@/api/business/classify";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getClassify(recordId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除档案分类编号为"' + recordIds + '"的数据项？').then(function() {
        return delClassify(recordIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('business/classify/export', {
        ...this.queryParams
