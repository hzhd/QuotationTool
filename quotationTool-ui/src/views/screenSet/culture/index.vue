<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['setScreen:culture:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['setScreen:culture:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['setScreen:culture:remove']"
          >删除</el-button
        >
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['setScreen:culture:export']"
        >导出</el-button>
      </el-col> -->
      <right-toolbar
    ...
    >
      ...
      <el-table-column label="资讯标题" align="center" prop="zxTitle" />
      <el-table-column
        label="资讯时间"
        align="center"
        prop="zxTime"
      ...
      >
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.zxTime, "{y}-{m}-{d}") }}</span>
        </template>
      </el-table-column>
      <el-table-column
        label="创建时间"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除文化资讯配置编号为"' + ids + '"的数据项？')
        .then(function () {
