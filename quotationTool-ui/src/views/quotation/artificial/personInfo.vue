...
export default {
  data() {
    return {
      ...
      form: {
        ...
        cluesource: '人工服务',
        clueqenerationtime: this.formatDateTime(new Date()),
        customername: '',
        customerphone: '',
        province: '',
        city: '',
  ...
  mounted() {
    this.form.qrcodeId = this.storage.getItem("qrcodeId")
    ...
    btnContinue: function () {
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          this.form.customername = this.form.name
          this.form.customerphone = this.form.phonenumber
          this.form.province = this.form.regionProvince
          this.form.city = this.form.regionCity
          this.form.county = this.form.regionCountry
          ...
          if (this.form.name != undefined) {
            addEshopQuotation(this.form).then(response => {
